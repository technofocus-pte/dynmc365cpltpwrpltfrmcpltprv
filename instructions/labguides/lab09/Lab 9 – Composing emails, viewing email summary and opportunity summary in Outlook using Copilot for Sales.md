...
5.  In the textbox, enter a phrase to describe the kind of reply you
    want to send, for example ‘Send the acceptance’ and then select
    **Create draft**.
...
3.  Select **Draft an email**.

> ![](./media/image24.png)

4.  Select a pre-defined category.

5.  Review the suggested content. Select any of the suggested content.
    For example, select **Address a concern**.
...
10. Select **Add to email** to paste the content in the email body.
