...
6.  You can now proceed to next exercise.
...
5.  Under Select features, enable **Write an email, Ask a question** and
...
4.  If pop up appears, click **Launch Trial**.
...
11. Select your **Dataverse environment** and then click **Next**.
